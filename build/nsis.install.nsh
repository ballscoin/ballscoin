Name "ballscoin ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ballscoin/ballscoin/issues"
!define UPDATEURL "https://github.com/ballscoin/ballscoin/releases"
!define ABOUTURL "https://github.com/ballscoin/ballscoin#ethereum-go"
...
# Install ballscoin binary
Section "ballscoin" GETH_IDX
  SetOutPath $INSTDIR
  file {{.ballscoin}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ballscoin.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\ballscoin.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "ballscoin incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "ballscoin outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "ballscoin UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "ballscoin incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\ballscoin.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "ballscoin outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\ballscoin.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "ballscoin UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\ballscoin.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\ballscoin.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\ballscoin.ipc"
