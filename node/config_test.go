...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ballscoin.ipc", false, filepath.Join(os.TempDir(), "ballscoin.ipc")},
		{"data", "ballscoin.ipc", false, "data/ballscoin.ipc"},
		{"data", "./ballscoin.ipc", false, "./ballscoin.ipc"},
		{"data", "/ballscoin.ipc", false, "/ballscoin.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ballscoin.ipc", true, `\\.\pipe\ballscoin.ipc`},
		{"data", "ballscoin.ipc", true, `\\.\pipe\ballscoin.ipc`},
		{"data", `\\.\pipe\ballscoin.ipc`, true, `\\.\pipe\ballscoin.ipc`},
	}
